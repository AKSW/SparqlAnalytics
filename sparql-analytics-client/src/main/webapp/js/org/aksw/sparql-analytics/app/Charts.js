(function() {
	...
	var mathUtils = Namespace("org.aksw.utils");
	
	var ns = Namespace("org.aksw.sparql-analytics.charts");
	
	var charts = ns;

	
	ns.createHistogramData = function(apiResponse) {
		var result = {
			min: 0,
			max: null,
	...
	ns.createHistogramChartSpec = function(data) {
		var result = {
            ...
            title: {
                text: "Recent Query Load" // 'DBpedia LinkedGeoData Cities'
            },
            subtitle: {
